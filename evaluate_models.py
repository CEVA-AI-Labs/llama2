...
if __name__ == '__main__':
    ...
    config_list = [
        # 'float',
        # 'configs/smoothquant_w8a8_per_channel_per_channel_dynamic.yaml',
        # 'configs/smoothquant_w8a8_per_channel_per_tensor_matmul_dynamic.yaml',
        'configs/smoothquant_w8a8_per_channel_per_tensor_matmul_static.yaml',
        'configs/w4a8_per_channel_per_channel_dynamic.yaml',
        'configs/w4a8_per_channel_per_tensor_matmul_dynamic.yaml',
        'configs/w8a8_per_channel_per_channel_dynamic.yaml',
        'configs/w8a8_per_channel_per_tensor_matmul_dynamic.yaml',
        'configs/w8a8_per_channel_per_tensor_matmul_static.yaml',
        'configs/w8a8_per_tensor_per_channel_dynamic.yaml'
    ]
    ppl_list = []
        ...
        with torch.no_grad():
            if config_name != 'float':
                ...
                if conf['QAT']['data_quantization']['quantization_mode'] == 'static':
                    ...
                    calib_loader = get_calibration_loader(tokenizer, seq_len=2048)
            ...
            ppl = evaluate(model, tokenizer, seq_len=2048)
